...
public class MouseInput {
    ...
    // Hold onto our callback references
    // Callbacks are implemented in native code, so if we don't hold onto our reference,
    // they will be GC'd, and then we will see an exception like this:
    // 
    // Exception in thread "GAME_LOOP_THREAD" org.lwjgl.system.libffi.ClosureError: 
    // Callback failed because the closure instance has been garbage collected
